...
var PoolClientManager = (function () {
  ...
  PoolClientManager.prototype.query = function (sql, args, m, fields) {
    return queryWithclient(this.client, sql, args, m, fields);
  };
  PoolClientManager.prototype.queryOne = function (sql, args, m, fields) {
...
exports.exec = exec;
function query(pool, sql, args, m, fields) {
  var p = toArray(args);
  return new Promise(function (resolve, reject) {
    return pool.query(sql, p, function (err, results) {
      if (err) {
...
exports.query = query;
function queryOne(pool, sql, args, m, fields) {
  return query(pool, sql, args, m, fields).then(function (r) {
...
function queryWithclient(client, sql, args, m, fields) {
  var p = toArray(args);
  return new Promise(function (resolve, reject) {
    return client.query(sql, p, function (err, results) {
      if (err) {
...
function queryOneWithClient(client, sql, args, m, fields) {
  return queryWithclient(client, sql, args, m, fields).then(function (r) {
    return (r && r.length > 0 ? r[0] : null);
  });
}
...
function handleResults(r, m, fields) {
  if (m) {
...
function handleBool(objs, fields) {
