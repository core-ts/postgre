...
var PoolClientManager = (function () {
  ...
  PoolClientManager.prototype.execBatch = function (statements) {
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          _a.sent();
          arrPromise = statements.map(function (item) { return client.query(item.query, item.params ? item.params : []); });
          c_1 = 0;
...
function execBatchWithClient(client, statements) {
  return __awaiter(this, void 0, void 0, function () {
